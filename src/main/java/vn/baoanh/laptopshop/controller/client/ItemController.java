...
public class ItemController {
    ...
    public String getProductPage(Model model, @PathVariable long id) {
        ...
        Map<String, Long> factoryCounts = this.productService.getFactoryCounts();
        model.addAttribute("factoryCounts", factoryCounts);
    ...
    public String handlePlaceOrder(
        ...
        vn.baoanh.laptopshop.domain.Order order = this.productService.handlePlaceOrder(currentUser, session, receiverName, receiverAddress, receiverPhone, paymentMethod);

        if ("VNPAY".equals(paymentMethod) && order != null) {
            return "redirect:/payment/vnpay?orderId=" + order.getId() + "&amount=" + (long)order.getTotalPrice();
        }
