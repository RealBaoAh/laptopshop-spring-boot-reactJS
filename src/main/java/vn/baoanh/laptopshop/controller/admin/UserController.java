package vn.baoanh.laptopshop.controller.admin;
...
public class UserController {
    ...
    public String getHomePage(Model model) {
        ...
        model.addAttribute("baoanh", "from controller with model");
        return "hello";
    }
    ...
    public String createUserPage(Model model,
            @ModelAttribute("newUser") @Valid User baoanh,
            BindingResult newUserBindingResult,
            @RequestParam("baoanhFile") MultipartFile file) {
...
public String postUpdateUser(Model model, 
        @ModelAttribute("newUser") User baoanh,
