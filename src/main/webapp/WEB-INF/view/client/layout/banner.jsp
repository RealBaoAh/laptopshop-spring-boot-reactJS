            ...
            <div class="container py-5">
                <div class="row g-5 align-items-center">
                    <div class="col-md-12 col-lg-7">
                        ...
                        <div class="position-relative mx-auto" style="max-width: 400px; margin-left: 0 !important;">
                            <input id="homeSearchInput"
                                class="form-control border-2 border-secondary w-100 py-3 px-4 rounded-pill" type="text">
                            <button type="button"
                                class="btn btn-primary border-2 border-secondary py-3 px-4 position-absolute rounded-pill text-white h-100"
                                style="top: 0; right: 0;">Tìm</button>
                            <div id="searchResults"
                                class="position-absolute w-100 bg-white border border-secondary rounded mt-1 d-none text-start"
                                style="z-index: 999; max-height: 300px; overflow-y: auto;">
                            </div>
                        </div>
                    </div>
