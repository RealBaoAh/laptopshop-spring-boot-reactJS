            ...
            <body>
                ...
                <script>
                    $(document).ready(function() {
                                        ...
                                        success: function(res) {
                                            ...
                                            if (res && res.length > 0) {
                                                res.forEach(function(item) {
                                                    ...
                                                    var html = '<a href="/product/' + item.id + '" class="d-flex align-items-center p-2 text-decoration-none border-bottom text-dark">' +
                                                                '<img src="/images/product/' + item.image + '" alt="" style="width: 50px; height: 50px; object-fit: cover;" class="me-3 rounded">' +
                                                                '<div>' +
                                                                    '<h6 class="mb-0" style="font-size: 14px;">' + item.name + '</h6>' +
                                                                    '<small class="text-danger fw-bold">' + formattedPrice + '</small>' +
                                                                '</div>' +
                                                            '</a>';
                                                    $resultsContainer.append(html);
                                                });
                                            } else {
                                                $resultsContainer.append('<div class="p-3 text-center text-muted">Không tìm thấy sản phẩm</div>');
                                            }
                        ...
                        $('#homeSearchInput').on('click', function() {
