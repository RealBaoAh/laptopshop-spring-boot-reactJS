                                                ...
                                                <ul class="list-unstyled fruite-categorie">
                                                    <li>
                                                        <div class="d-flex justify-content-between fruite-name">
                                                            <a href="#">Apple</a>
                                                            <span>(${not empty factoryCounts['APPLE'] ? factoryCounts['APPLE'] : 0})</span>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="d-flex justify-content-between fruite-name">
                                                            <a href="#">Asus</a>
                                                            <span>(${not empty factoryCounts['ASUS'] ? factoryCounts['ASUS'] : 0})</span>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="d-flex justify-content-between fruite-name">
                                                            <a href="#">Dell</a>
                                                            <span>(${not empty factoryCounts['DELL'] ? factoryCounts['DELL'] : 0})</span>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="d-flex justify-content-between fruite-name">
                                                            <a href="#">HP</a>
                                                            <span>(${not empty factoryCounts['HP'] ? factoryCounts['HP'] : 0})</span>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="d-flex justify-content-between fruite-name">
                                                            <a href="#">Acer</a>
                                                            <span>(${not empty factoryCounts['ACER'] ? factoryCounts['ACER'] : 0})</span>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="d-flex justify-content-between fruite-name">
                                                            <a href="#">Lenovo</a>
                                                            <span>(${not empty factoryCounts['LENOVO'] ? factoryCounts['LENOVO'] : 0})</span>
                                                        </div>
                                                    </li>
                                                </ul>
                                            </div>
